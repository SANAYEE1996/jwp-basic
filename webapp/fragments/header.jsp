	            ...
	            <ul class="nav navbar-nav navbar-right">
	                ...
	                <c:choose>
	                	<c:when test="${empty sessionScope.user}">
	                		<li><form action="/user/login" method="get"><button type="submit">로그인</button></form></li>
	                		<li><a href="../user/form.jsp" role="button">회원가입</a></li>
	                	</c:when>
	                	<c:otherwise>
	                		<li><form action="/user/logout" method="get"><button type="submit">로그아웃</button></form></li>
	                		<li><form action="/user/update?userId=${sessionScope.user.userId}" method="get"><button type="submit">개인정보수정</button></form></li>
	                	</c:otherwise>
	                </c:choose>
	                <!--
