			...
			<div class="content-main">
				<article class="article">
					...
					<div class="article-util">
						<ul class="article-util-list">
							<li>
								<a class="link-modify-article" href="/qna/updateForm?questionId=${question.questionId}&writerId=${question.writerId}">수정</a>
							</li>
							<li>
				...
				<div class="qna-comment">
					<div class="qna-comment-slipp">
						<p class="qna-comment-count"><strong class="answer-Count">${answerCount}</strong>개의 의견</p>
						<div class="qna-comment-slipp-articles">
							<c:forEach items="${answers}" var="each">
							<article class="article_${each.answerId}">
								<div class="article-header">
									<div class="article-header-thumb">
									...
									<ul class="article-util-list">
										...
										<li>
											<form class="form-delete" action="/api/qna/deleteAnswer" method="POST">
												...
												<button type="submit" class="link-delete-article" value="${each.answerId}">삭제</button>
											</form>
										</li>
									</ul>
								</div>
